...
public class RuntimeAnalysis {
    ...
    private static final Integer[] VERY_SMALL_INPUT_SIZES = {
            100,
            200,
            400,
            800,
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < SMALL_INPUT_SIZES.length; i++) {
            ...
            ArrayList<Integer> verySmallList = generateArrayList(VERY_SMALL_INPUT_SIZES[i]);

            timings.add(measureAndPrintSortingTime("Insertion Sort", smallList));
            timings.add(measureAndPrintSortingTime("Quick Sort", verySmallList));
    ...
    /*
     * Generate Array (faster insertion sort)
     */
    /*
    public static ArrayList<Integer> generateArrayList(int size) {
        ArrayList<Integer> arr = new ArrayList<>();
     ...
     */
    /*
     * Generate Array (slower quick sort)
     */
    /*
    public static ArrayList<Integer> generateArrayList(int size) {
        ArrayList<Integer> arr = new ArrayList<>();
     ...
     */
    /*
     * Generate Array (slower bucket sort)
     */
    /*
    public static ArrayList<Integer> generateArrayList(int size) {
        ArrayList<Integer> arr = new ArrayList<>();
     ...
     */
    /*
     * Generate Array (slower count sort)
     */
    /*
    public static ArrayList<Integer> generateArrayList(int size) {
        ArrayList<Integer> arr = new ArrayList<>();
